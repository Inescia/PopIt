...
abstract class AppLocalizations {
  ...
  /// No description provided for @new_bubble.
  ///
  /// In en, this message translates to:
  /// **'New Bubble'**
  String get new_bubble;
  ...
  /// No description provided for @field_name_required.
  ///
  /// In en, this message translates to:
  /// **'Name is required.'**
  String get field_name_required;

  /// No description provided for @type_punctual.
  ///
  /// In en, this message translates to:
  /// **'Punctual'**
  String get type_punctual;

  /// No description provided for @type_daily.
  ///
  /// In en, this message translates to:
  /// **'Daily'**
  String get type_daily;

  /// No description provided for @type_weekly.
  ///
  /// In en, this message translates to:
  /// **'Weekly'**
  String get type_weekly;

  /// No description provided for @type_monthly.
  ///
  /// In en, this message translates to:
  /// **'Monthly'**
